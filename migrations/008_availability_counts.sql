-- Migration 008: Add available_count, occupied_count, out_of_service_count to bbox function.
-- These are aggregated from monta_evses.availability_status (kept current by background poller).
