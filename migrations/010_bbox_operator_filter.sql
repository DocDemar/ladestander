-- Migration 010: Tilføj operator_name som optional parameter til bbox-funktionen.
-- Widget3 prefilter sender ?operator_name=Norlys (uden eq. prefix), som PostgREST
-- tolker som et funktionsargument. Med DEFAULT NULL filtrerer funktionen selv.
